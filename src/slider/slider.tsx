...
export default class Slider extends React.Component<React.InputHTMLAttributes<HTMLInputElement>, HTMLInputElement> {
    ...
    render(): React.ReactNode {
        ...
        return (
            <div className="labelled-slider">
                <Slider {...sliderProps} />
                <TinyLabel>{this.props.label ? this.props.label(this.state.value) : ''}</TinyLabel>
            </div>
        )
    }
}
